...
official/supported Docker Images found at https://hub.docker.com/r/kiipay/kiid/
...
**NOTE: Please update the image description at https://hub.docker.com/r/kiipay/kiid-develop/ when changing the above text**